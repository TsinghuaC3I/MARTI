...
LOG_DIR=/mnt/shared-storage-user/marti/OpenRLHF/logs/ma-test-gspo_tis_datafilter_overlong_openrlhf_qwen3-8B_lpf.log
...
python3 -m openrlhf.cli.multi_agent_train_ppo_ray_lfy \
