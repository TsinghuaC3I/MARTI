...
python3 -m openrlhf.cli.multi_agent_train_ppo_ray \
    ...
    --input_key="prompt" \
    --label_key="label" \
    --agent_func_path /mnt/shared-storage-user/marti/OpenRLHF/openrlhf/agent_workflows/ab_mcts_workflow.py \
    --load_checkpoint \
    --use_tensorboard "${TENSORBOARD}" 2>&1 | tee /mnt/shared-storage-user/marti/OpenRLHF/logs/wsj_ma-test-gspo_tis_datafilter_overlong_openrlhf_qwen3-8B.log