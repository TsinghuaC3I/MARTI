...
TENSORBOARD="${ROOT_DIR}/logs/tensorboard/${ADVANTAGE}-${SHORT_NAME}-${TASK}-db-${EXP}-fyk-single"
LOG_DIR=/mnt/shared-storage-user/marti/OpenRLHF/logs/single_ma-test-gspo_tis_datafilter_overlong_openrlhf_${SHORT_NAME}_fyk.log
