...
WORKFLOW_SAVE_PATH="${ROOT_DIR}/outputs/workflow/${SHORT_NAME0}-${SHORT_NAME1}-${TASK}"

EXP=gspo-tis-df-overlong-fyk-multi
TENSORBOARD="${ROOT_DIR}/logs/tensorboard/${ADVANTAGE}-${SHORT_NAME0}-${SHORT_NAME1}-${TASK}-db-${EXP}-fyk-multi"
LOG_DIR=/mnt/shared-storage-user/marti/OpenRLHF/logs/multi_ma-test-gspo_tis_datafilter_overlong_openrlhf_${SHORT_NAME0}_${SHORT_NAME1}_fyk.log
