...
EXP=ma-test-${ADVANTAGE}-${SHORT_NAME}-${TASK}-gspo-tis-df-overlong-lpf
...
LOG_DIR=/mnt/shared-storage-user/marti/OpenRLHF/logs/${EXP}.log
...
AGENT0="{
    \"0\": {
        \"role\": \"generator\",
        \"pretrain\": \"${PRETRAIN}\",
        \"save_path\": \"/mnt/shared-storage-user/marti/OpenRLHF/outputs/final/${EXP}-agent1\",
        \"ckpt_path\": \"/mnt/shared-storage-user/marti/OpenRLHF/outputs/ckpt/${EXP}-agent1\",
        \"is_tuning\": true
    }
}"
...
AGENT1="{
    \"1\": {
        \"role\": \"generator\",
        \"pretrain\": \"${PRETRAIN}\",
        \"save_path\": \"/mnt/shared-storage-user/marti/OpenRLHF/outputs/final/${EXP}-agent2\",
        \"ckpt_path\": \"/mnt/shared-storage-user/marti/OpenRLHF/outputs/ckpt/${EXP}-agent2\",
        \"is_tuning\": true
    }
}"
...
mkdir -p "${TENSORBOARD}"
mkdir -p "/mnt/shared-storage-user/marti/OpenRLHF/outputs/final/${EXP}-agent1"
mkdir -p "/mnt/shared-storage-user/marti/OpenRLHF/outputs/final/${EXP}-agent2"
mkdir -p "/mnt/shared-storage-user/marti/OpenRLHF/outputs/ckpt/${EXP}-agent1"
mkdir -p "/mnt/shared-storage-user/marti/OpenRLHF/outputs/ckpt/${EXP}-agent2"
