...
class AgentInstance(AgentInstanceBase):
    async def __init__(self, *args, **kwargs):
        self.step_idx = 0
        self.max_steps = 1 # random.randint(1, 3)  # 1-3 steps
    ...
    async def step(self, states: dict, **kwargs) -> Dict[str, Any]:
        ...
        reward = code_verify(label, action_text)
...
async def step(states: dict, **kwargs) -> Dict[str, Any]:
    """Execute one step of verification and return environment feedback
...
class AgentExecutor(AgentExecutorBase):
    def __init__(self, max_steps, max_length, llm_engine, hf_tokenizer, result_queue, agent_func_path=None):
        super().__init__(AgentInstance, max_steps, max_length, llm_engine, hf_tokenizer, result_queue, agent_func_path=agent_func_path)
