...
SHORT_NAME0=${1:-"Qwen3-4B-Instruct-2507"}
...
LOG_DIR=/mnt/shared-storage-user/marti/MARTI-v2/logs/${ADVANTAGE}-${SHORT_NAME}-${TASK}-${EXP}.log
...
AGENT0="{
    \"0\": {
        \"role\": \"generator\",
        \"pretrain\": \"${PRETRAIN0}\",
        \"save_path\": \"/mnt/shared-storage-user/marti/MARTI-v2/outputs/final/${ADVANTAGE}-${SHORT_NAME0}-${TASK}-${EXP}-agent0\",
        \"ckpt_path\": \"/mnt/shared-storage-user/marti/MARTI-v2/outputs/ckpt/${ADVANTAGE}-${SHORT_NAME0}-${TASK}-${EXP}-agent0\",
        \"is_tuning\": true
    }
}"
...
AGENT1="{
    \"1\": {
        \"role\": \"generator\",
        \"pretrain\": \"${PRETRAIN1}\",
        \"save_path\": \"/mnt/shared-storage-user/marti/MARTI-v2/outputs/final/${ADVANTAGE}-${SHORT_NAME1}-${TASK}-${EXP}-agent1\",
        \"ckpt_path\": \"/mnt/shared-storage-user/marti/MARTI-v2/outputs/ckpt/${ADVANTAGE}-${SHORT_NAME1}-${TASK}-${EXP}-agent1\",
        \"is_tuning\": true
    }
}"
...
mkdir -p "${TENSORBOARD}"
mkdir -p "/mnt/shared-storage-user/marti/MARTI-v2/outputs/final/${ADVANTAGE}-${SHORT_NAME0}-${TASK}-${EXP}-agent0"
mkdir -p "/mnt/shared-storage-user/marti/MARTI-v2/outputs/final/${ADVANTAGE}-${SHORT_NAME1}-${TASK}-${EXP}-agent1"
mkdir -p "/mnt/shared-storage-user/marti/MARTI-v2/outputs/ckpt/${ADVANTAGE}-${SHORT_NAME0}-${TASK}-${EXP}-agent0"
mkdir -p "/mnt/shared-storage-user/marti/MARTI-v2/outputs/ckpt/${ADVANTAGE}-${SHORT_NAME1}-${TASK}-${EXP}-agent1"
