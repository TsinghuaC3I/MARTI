...
from marti.models import Actor, PolicyLoss
from marti.models.utils import compute_approx_kl, masked_mean
from marti.trainer.ppo_utils.experience_maker import Experience
from marti.utils import get_tokenizer
from marti.utils.deepspeed import DeepspeedStrategy
from marti.utils.deepspeed.deepspeed_utils import offload_deepspeed_states, reload_deepspeed_states
from marti.utils.distributed_util import stateless_init_process_group, torch_dist_barrier_and_cuda_sync, init_process_group
...
class PolicyModelActor(BaseModelActor):
    def init_model_from_pretrained(self, strategy: DeepspeedStrategy, pretrain, max_steps=None, vllm_engines=None, actor_ckpt_path=None):
        ...
        if args.load_checkpoint and os.path.exists(ckpt_path):
            ...
            # TODO add step info for all agents
            self.checkpoint_states["agent_0_step"] = states.get("agent_0_step", 0)
            self.checkpoint_states["agent_1_step"] = states.get("agent_1_step", 0)
