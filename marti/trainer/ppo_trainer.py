...
from marti.trainer.ppo_utils.experience_maker import RemoteExperienceMaker
    ...
    def __init__(
        ...
        **generate_kwargs,
        ...
        if self.args.agent_func_path:
            from marti.trainer.ppo_utils.experience_maker_async import SamplesGeneratorAsync as SamplesGenerator
        else:
            from marti.trainer.ppo_utils.experience_maker import SamplesGenerator
